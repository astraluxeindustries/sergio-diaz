      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-white font-serif text-2xl font-bold mb-4">Sergio Diaz</h3>
            <p className="mb-4 text-slate-400 max-w-sm">
              Helping families in St. George achieve their homeownership dreams with integrity, transparency, and expertise.
            </p>
        ...
        <div className="border-t border-slate-800 pt-8 text-sm text-center md:text-left flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {new Date().getFullYear()} Sergio Diaz | Intercap Lending. All rights reserved.</p>
